...
OutputBaseFilename=MSUScripter_{#MyAppVersion}-win
Compression=lzma
...
Source: "..\MSUScripter\bin\Release\net7.0\win-x64\publish\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; Check: Is64BitInstallMode;
Source: "..\MSUScripter\bin\Release\net7.0\win-x86\publish\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; Check: "not Is64BitInstallMode";
